 ...
 * */
enqueteControllers
    .controller('EnqueteEditCtrl', ['$scope', '$http', 'Enquete', '$state', '$modal', function ($scope, $http, Enquete, $state, $modal) {
        $scope.perguntas = [{
            repostas: []
        }];
        ...
        $scope.removePergunta = function (index) {
            ...
            modal.result.then(function () {
                var pergunta = $scope.perguntas[index];
        ...
        $scope.removeResposta = function (index, parentIndex) {
            ...
            modal.result.then(function () {
                var resposta = $scope.perguntas[parentIndex].respostas[index];
