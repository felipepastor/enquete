...
<div class="row">
    <form class="col-md-6" ng-submit="submit()">
        ...
        <div class="checkbox">
            <label>
                <input type="checkbox" ng-checked="enquete.ativa" ng-model="enquete.ativa"> Pública?
            </label>
        </div>
    ...
    <form class="col-md-6 form_enquete">
        ...
        <div class="input-group">
            <input type="text" class="form-control" id="nome_da_pergunta[]" placeholder="Nome da pergunta">
